...
function get_source_containers (room) {
  let room_sources = room.find(FIND_SOURCES)
...
function summarize_room_internal (room) {
  ...
  // const source_container_by_id = get_source_containers(room)
...
//-----------------------------------------------------------------
  ...
  const room_enemies = summarize_room_enemies(room)
